...
<body>
    ...
    <div class="under_title">
        <div class="under_title_inner center">
            <h2>
                <img class="sp contents_title" src="../img/title_news_sp.svg" alt="お知らせ">
                <img class="pc contents_title" src="../img/title_news_pc.svg" alt="お知らせ">
            </h2>
        </div>
    </div>
    <section class="news">
        <h3 class="page_title">お知らせタイトル</h3>
