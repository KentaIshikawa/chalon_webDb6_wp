...
<head>
    ...
    <link rel="stylesheet" href="../css/page/lesson.css">
</head>
...
<body>
    ...
    <div class="under_title">
        <div class="under_title_inner center">
            <h2>
                <img class="sp contents_title" src="../img/title_lesson_sp.svg" alt="お菓子教室">
                <img class="pc contents_title" src="../img/title_lesson_pc.svg" alt="お菓子教室">
            </h2>
        </div>
    </div>
